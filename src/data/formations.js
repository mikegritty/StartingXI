...
const FORMATIONS = {
  ...
  '4-5-1': {
    ...
    positions: [
      ...
      { role: 'DEF', position: 'CB',  number: 6,  x: 0.62, y: 0.79 },
      { role: 'DEF', position: 'LB',  number: 3,  x: 0.82, y: 0.79 },
      { role: 'MID', position: 'RM',  number: 7,  x: 0.10, y: 0.62 },
      { role: 'MID', position: 'CM',  number: 8,  x: 0.30, y: 0.62 },
      { role: 'MID', position: 'CDM', number: 4,  x: 0.50, y: 0.62 },
      { role: 'MID', position: 'CM',  number: 10, x: 0.70, y: 0.62 },
      { role: 'MID', position: 'LM',  number: 11, x: 0.90, y: 0.62 },
  ...
  '3-4-3': {
    ...
    positions: [
      ...
      { role: 'MID', position: 'RWB', number: 2,  x: 0.12, y: 0.63 },
      { role: 'MID', position: 'CM',  number: 8,  x: 0.35, y: 0.63 },
      { role: 'MID', position: 'CM',  number: 10, x: 0.65, y: 0.63 },
      { role: 'MID', position: 'LWB', number: 3,  x: 0.88, y: 0.63 },
      { role: 'FWD', position: 'RW',  number: 7,  x: 0.18, y: 0.44 },
      { role: 'FWD', position: 'ST',  number: 9,  x: 0.50, y: 0.44 },
      { role: 'FWD', position: 'LW',  number: 11, x: 0.82, y: 0.44 },
    ],
  },
  '3-4-2-1': {
    label: '3-4-2-1',
...
/**
 * The 5 most common formations shown as quick-pick buttons.
 * The rest appear in the "More…" dropdown.
 */
export const QUICK_FORMATIONS = ['4-3-3', '4-2-3-1', '4-4-2', '3-4-3', '5-3-2']
